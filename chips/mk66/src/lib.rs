...
pub static INTERRUPT_TABLE: [Option<unsafe extern fn()>; 99] = [
    ...
    /* SPI0 */          Option::Some(unhandled_interrupt),
    /* SPI1 */          Option::Some(unhandled_interrupt),
    ...
    /* PCMA */          Option::Some(unhandled_interrupt),
    /* PCMB */          Option::Some(unhandled_interrupt),
    /* PCMC */          Option::Some(unhandled_interrupt),
    /* PCMD */          Option::Some(unhandled_interrupt),
    /* PCME */          Option::Some(unhandled_interrupt),
    /* SOFTWARE */      Option::Some(unhandled_interrupt),
    /* SPI2 */          Option::Some(unhandled_interrupt),
